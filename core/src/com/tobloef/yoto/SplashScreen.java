...
public class SplashScreen implements Screen {
    //The public key used for the in app purchases
    ...
    //The ids for the in app purchases
    private final String skips10ID = "10skips";
    private final String skips50ID = "50skips";
    private final YouOnlyTapOnce game;
    //The minimum time the splash screen should be displayed
    private final long minSplashTime = 2000L; //2 seconds
    ...
    public void show() {
        ...
        //If this is the first time the game is launched, give the player 3 free skips
        ...
        //Below we specify a number of bitmap fonts to be generated by the asset manager
        //This way the fonts will always be the perfect size, no matter the screen size
        ...
        //Here all assets are added to the asset manager for loading
